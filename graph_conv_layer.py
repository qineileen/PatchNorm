...
class GraphConvolution(nn.Module):
    ...
    def forward(self, input, adj):
        ...
        if self.batchnorm is not None:
           ...
           # Original from Salva Ruhling Cachay, PatchNorm cycle Modified by Qin Yuxuan, Shanghai Pinghe School
            relationGroups=groupByRelations(adj)
            for item in relationGroups:
                node_repr[...,item] = self.batchnorm(node_repr[...,item])
